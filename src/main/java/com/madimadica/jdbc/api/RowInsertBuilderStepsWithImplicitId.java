...
/**
 * Namespace container for the fluent builder steps used by {@link RowInsertBuilderWithImplicitId} to construct a {@link RowInsert}.
 */
public class RowInsertBuilderStepsWithImplicitId {

    /**
     * Prevent user construction
     */
    private RowInsertBuilderStepsWithImplicitId() {}
